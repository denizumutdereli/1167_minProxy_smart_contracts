...
contract Manager is CustomOwnable, Pausable, ReentrancyGuard {
    ...
    function createCrowdSale(
        ...
        IErc20(address(_baseAsset)).excludeFromDividends(address(roundClone), true);
        IErc20(address(_baseAsset)).addRemoveFromTax(address(roundClone), true);
